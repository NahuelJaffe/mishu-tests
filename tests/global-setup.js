...
async function globalSetup(config) {
  ...
  try {
    ...
    try {
      ...
      await page.goto(process.env.BASE_URL || '${process.env.BASE_URL || 'https://mishu-web--pr68-e2e-analytics-disabl-v7gcnvxb.web.app/'}/', { 
        timeout: timeout,
      ...
      await page.goto(`${process.env.BASE_URL || '${process.env.BASE_URL || 'https://mishu-web--pr68-e2e-analytics-disabl-v7gcnvxb.web.app/'}/'}/login`, { 
        timeout: timeout,
